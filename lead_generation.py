        ...
        if not possible_company:
            ...
            if domain_match:
                ...
                if len(domain_parts) > 1:
                    ...
                    if domain_parts[0] not in ["linkedin", "github", "facebook", "twitter", "threads", "quora", "reddit"]:
...
if selected == "👤 Lead Contacts":
    ...
    if start_lead_scraping:
        ...
        TARGET_SITES_LEADS = ["linkedin.com", "github.com", "facebook.com", "twitter.com", "threads.net", "quora.com", "reddit.com"]
